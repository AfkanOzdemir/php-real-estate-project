...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (
            ...
            //Add estate
            $sql = "INSERT INTO emlaklar (sahip_id, ilan_no, guncel_tarih, baslik, fiyat, kategori, tipi, oda, il, ilce, mahalle, mkare, kat, aciklama, r1, r2, r3, r4, r5) VALUES ('$sahipId', '$ilanNo', '$guncelTarih', '$baslik', '$fiyat', '$kategori', '$tipi', '$oda', '$il', '$ilce', '$mahalle', '$mkare', '$kat', '$aciklama', '$target_file1', '$target_file2', '$target_file3', '$target_file4', '$target_file5')";
